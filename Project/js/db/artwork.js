const artworks = [
  {
    ...
    price: 500,
    quantity: 11,
    description: "The drawing dances on the paper, a mesmerizing interplay of blues. The main form, the jellyfish itself, is a swirling mass of cerulean, fading towards the edges into a hazy sapphire.",
    images: {
  ...
  },
  {
    ...
    price: 400,
    quantity: 5,
    description: "Eight swirling arms of cobalt blue dance across the page, a mesmerizing creature from the deep.",
    images: {
  ...
  },
  {
    ...
    price: 200,
    quantity: 8,
    description: "A mesmerizing turquoise orb pulsates on the page, trailing ethereal tendrils in shades of the sea.",
    images: {
